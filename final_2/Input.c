...
int optionMainMenu(void){
    ...
    char menuPrinsipalMensaje[] =
             "\n\n============================================\
                \n| ADMINISTRACION DE ENTREGA DE MERCADERIA  |\
                \n============================================\
                \n============================================\
                \n|       *      MENU PRINCIPAL      *       |\
                \n============================================\
...
int optionModifyMenu(void){
    ...
    char menuModificarEntregaMensaje[] =
             "\n\n============================================\
                \n|       *      MENU MODIFICAR      *       |\
                \n============================================\
    ...
    char menuModificarEntregaMensajeError[] = "\nSe debe elegir una opcion del 1 al 4";

    option = getValidInt(menuModificarEntregaMensaje, menuModificarEntregaMensajeError, 1, 4);
    return option;
}
