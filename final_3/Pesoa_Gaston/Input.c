...
int optionModifyMenu(void){
    ...
    char menuModificarLlamadaMensaje[] =
             "\n\n============================================\
                \n|       *      MENU MODIFICAR      *       |\
                \n============================================\
                \n| 1 - Modificar nombreCliente                |\
                \n| 2 - Modificar importe                    |\
    ...
    char menuModificarLlamadaMensajeError[] = "\nSe debe elegir una opcion del 1 al 4";

    option = getValidInt(menuModificarLlamadaMensaje, menuModificarLlamadaMensajeError, 1, 4);
    return option;
}
