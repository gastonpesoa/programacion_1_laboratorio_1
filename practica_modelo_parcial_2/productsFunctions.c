...
void altaProduct(EProduct productsArray[], int productsArrayLenght,EProv provsArray[],int provsArrayLenght){
    ...
    if (freePlaceIndex == -1) {
        ...
        setProduct(productsArray, freePlaceIndex, nameAux, freePlaceIndex, provIdAux, priceAux, stockAux);
...
void showProductsArray(EProduct productsArray[],int productsArrayLenght,EProv provsArray[],int provsArrayLenght){
    ...
    for (i=0; i < productsArrayLenght; i++) {
        if (productsArray[i].status != INACTIVE){
            ...
            printf("\n| %6d  | %-40s | %5f | %5d | %-40s |",productsArray[i].productId,productsArray[i].name,productsArray[i].price,productsArray[i].stock,provNameAux);
...
void showProduct(EProduct productsArray,EProv provsArray[],int provsArrayLenght){
    ...
    printf("\n| %6d  | %-40s | %5f | %5d | %-40s |",productsArray.productId,productsArray.name,productsArray.price,productsArray.stock,provNameAux);
}
