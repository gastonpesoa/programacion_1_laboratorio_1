...
int optionModifyMenu(void){
    ...
    char menuModificarUsuarioMensaje[] =
             "\n\n============================================\
                \n|       *      MENU MODIFICAR      *       |\
                \n============================================\
    ...
    char menuModificarUsuarioMensajeError[] = "\nSe debe elegir una opcion del 1 al 4";

    option = getValidInt(menuModificarUsuarioMensaje, menuModificarUsuarioMensajeError, 1, 4);
    return option;
}
