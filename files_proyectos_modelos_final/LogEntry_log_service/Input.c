...
int optionMainMenu(void){
    ...
    char menuPrinsipalMensaje[] =
             "\n\n============================================\
                \n|     REPORTE DE FALLOS DE SERVIDOR WEB    |\
                \n============================================\
                \n============================================\
                \n|       *      MENU PRINCIPAL      *       |\
                \n============================================\
                \n| 1 - LeerLog                              |\
                \n| 2 - Mostrar listas                       |\
                \n| 3 - Procesar información                 |\
                \n| 4 - Mostrar estadísticas                 |\
                \n| 5 - Salir                                |\
                \n============================================\
                \n| Ingrese una opcion:                      |\
                \n============================================\n";
...
int optionModifyMenu(void){
    ...
    char menuModificarLogEntryMensaje[] =
             "\n\n============================================\
                \n|       *      MENU MODIFICAR      *       |\
                \n============================================\
    ...
    char menuModificarLogEntryMensajeError[] = "\nSe debe elegir una opcion del 1 al 4";

    option = getValidInt(menuModificarLogEntryMensaje, menuModificarLogEntryMensajeError, 1, 4);
    return option;
}
